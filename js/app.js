        ...
        async function startSilentAudio() {
            ...
            try {
                ...
                // Configurar MediaSession para que el sistema sepa que hay algo "reproduciendo"
                if ('mediaSession' in navigator) {
                    navigator.mediaSession.metadata = new MediaMetadata({
                        title: 'MediClock (En espera)',
                        artist: 'Protección activa',
                        album: 'Sistema Neón',
                ...
                console.log('⚠️ No se pudo iniciar el audio de silencio automáticamente. Pendiente de interacción.');
            }
        }
